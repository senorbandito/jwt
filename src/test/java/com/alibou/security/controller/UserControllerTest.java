...
//    MockMvc mockMvc;
    ...
    void init(){
        user1 = new User("Jurgen", "Klopp", "98765432", new Date(693878400000L),  "jurgen@gmail.com", "password", USER);
//        user2 = new User("Mikel", "Arteta", "88765432", new Date(693878400000L), "jurgen@gmail.com", "password");
//        updatedUser1 = new User("Jurgen", "Klopp", "98765432", new Date(693878400000L),  "jurgen@gmail.com", "password");
         user1 = RegisterRequest.builder()
                .firstname("Admin")
                .lastname("Admin")
