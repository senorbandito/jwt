...
import com.alibou.security.plan.PlanController;
import com.alibou.security.plan.PlanService;
...
//    MockMvc mockMvc;
    ...
    void getProducts() throws Exception{
        ...
        this.mockMvc.perform(get("/api/v1/plans/plans")
    ...
    void getSingleProduct() throws Exception {
        ...
        this.mockMvc.perform(get("/api/v1/plans/plans/{id}","1")
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    void updateProduct() throws Exception{
        ...
        this.mockMvc.perform(put("/api/v1/plans/plans/{id}", "1").with(csrf())
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void deleteProduct() throws Exception{
        ...
        this.mockMvc.perform(delete("/api/v1/plans/plans/{id}", "1").with(csrf())
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id", is(plan1.getId())))
                .andExpect(jsonPath("$.name", is(plan1.getName())))
